  ...
  return (
    <Fragment>
      <div className="flex flex-row justify-between">
        <p className="text-xl font-bold">Daftar User</p>
      ...
      <div className="flex flex-col gap-2 p-2">
        <div className="flex flex-row bg-white rounded-xl overflow-hidden shadow-md p-4 undefined border border-3">
          <div className="p-1 w-4/5 flex flex-row gap-2">
            <h1 className="text-gray-900 text-xl font-serif font-bold w-1/4">Admin</h1>
            <div className="flex flex-col gap-2 w-3/4">
              <p className="text-gray-700 text-sm">Role: Master</p>
            </div>
          </div>
